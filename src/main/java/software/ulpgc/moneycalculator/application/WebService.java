...
public class WebService {
    ...
    public static class CurrencyLoader implements software.ulpgc.moneycalculator.io.CurrencyLoader {
    ...
    public static class ExchangeRateLoader implements software.ulpgc.moneycalculator.io.ExchangeRateLoader {
        @Override
